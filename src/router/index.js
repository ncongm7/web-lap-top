  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          path: 'checkout',
          name: 'checkout',
          component: () => import('@/views/ThanhToan/Checkout.vue'),
          meta: { title: 'Thanh toán - VietLapTop' },
        },
        {
          path: 'order-success/:orderId?',
          name: 'OrderSuccess',
          component: () => import('@/views/ThanhToan/OrderSuccess.vue'),
          meta: { title: 'Đặt hàng thành công - VietLapTop' },
        },
        {
          path: 'about',
          name: 'about',
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta && to.meta.hideForAuth && isAuthenticated) {
    next({ name: 'home' })
    return
  }
