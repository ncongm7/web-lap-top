  ...
  <div class="promotion-detail-page">
    <div class="container">
      ...
      <div v-else-if="error" class="error-state">
        ...
        <h3>{{ error }}</h3>
        <router-link to="/khuyen-mai" class="back-btn"> ← Quay lại danh sách </router-link>
      </div>
      ...
      <div v-else-if="campaignInfo" class="promotion-detail">
        ...
        <div class="promotion-header">
          <router-link to="/khuyen-mai" class="back-link"> ← Quay lại danh sách </router-link>
            ...
            >
              ...
              <div class="product-info">
                ...
                <div class="product-actions">
                  <button class="view-product-btn" @click.stop="goToProduct(product)">
                    Xem chi tiết →
                  </button>
                </div>
              </div>
...
const getOriginalPrice = (product) => {
  if (!product) return 0
  return product.giaGoc ?? product.giaNiemYet ?? product.giaBan ?? product.giaHienThi ?? 0
}
...
const hasDiscount = (product) => {
  ...
  const discounted = getDiscountPrice(product)
  return original > 0 && discounted > 0 && discounted < original
}
